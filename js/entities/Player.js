...
export class Player extends Phaser.Sprite {
	...
	gameLoadPackage(thePackage) {
		var theBox = new Box(this.game, 0, 0, thePackage, false)
	...
	dropItem() {
		...
		this.state.addDroppedItem(new Box(this.game, this.x, this.y, thePackage));
		this.boxDropSound.play('', 0, 1, false, true);
		this.recalculatePhysicsProps();
	}
	
	onHit(body1, body2, shape1, shape2, contactEq) {
